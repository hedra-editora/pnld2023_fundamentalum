...
%\newcommand{\imagemCapa}{./images/PNLD2023-035-C.jpg}
\newcommand{\issnppub}{978-85-7126-073-3}
%\newcommand{\issnepub}{978-65-86497-86-1}
...
%\Image{PNLD2023-035-08}{PNLD2023-035-08}
%\Image{PNLD2023-035-09}{PNLD2023-035-09}
...
% Esperamos que as atividades sugeridas e o material indicado sejam proveitosos em sala de aula! Já contamos, no entanto, com as adaptações que surgirão organicamente na recepção do mesmo por vocês, que possuem 
...
\SideImage{Exemplo de caça-palavra}{PNLD2023-035-06}
...
\SideImage{Ilustração de um tradicional jogo de forca. CC-BY}{PNLD2023-035-07}

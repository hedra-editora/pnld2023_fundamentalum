...
\newcommand{\imagemCapa}{./images/PNLD2023-006-C.jpg}
...
Os grupos poderão montar um painel informativo sobre a ave pesquisada, com fotos e mapas que apresentem sua localização no Brasil e no mundo, junto das principais características de sua espécie. Alguns tópicos importantes que devem constar no painel são:
...
\item O professor deverá trabalhar com os alunos as diferentes sonoridades dessas rimas.

\item O professor pode classificar, junto da turma, os tipos de rima encontrados.

\item O professor deverá discorrer acerca da estruturação dos versos a partir da observação dos alunos.

\item Os estudantes deverão anotar as palavras que não conhecem na obra e busquem seus significados em um dicionário. 

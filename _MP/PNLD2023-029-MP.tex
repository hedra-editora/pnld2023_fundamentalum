...
Este material tem a intenção de contribuir para que você consiga desenvolver um trabalho aprofundado com a obra \textit{Monteiro Lobato para crianças} em sala de aula.
...
Tratam-se tanto de contos como de capítulos extraídos de suas principais obras e que funcionam como narrativas independentes. A seleção tenta abarcar os trabalhos mais representativos de Lobato, funcionando como uma espécie de introdução à vasta produção literária do autor.
...
Após a reunião, os alunos produziram uma carta de apresentação e recomendação de Monteiro Lobato com o seguinte tema: ‘’Por que você vai gostar das histórias de Monteiro Lobato?’’. Cada grupo produzirá sua carta e, na sequência, trocarão as cartas entre si.

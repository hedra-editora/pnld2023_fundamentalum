...
Para a prática da \textit{literacia}, oferecemos um guia que pode ajudar nas orientações aos responsáveis pelo estudante, para incentivar o gosto pela leitura e contribuir para que eles desenvolvam habilidades relacionadas também em casa.  
...
Brasília: \textsc{mec, sealf}, 2019. Disponível \href{http://alfabetizacao.mec.gov.br/images/conta-pra-mim/conta-pra-mim-literacia.pdf}{neste link}.

Este guia oferece explicações em uma linguagem bastante acessível e detalhada as práticas de literacia: como praticar leitura dialogada, como narrar histórias, como exercitar interação oral, formas de proporcionar contatos com a escrita etc.
